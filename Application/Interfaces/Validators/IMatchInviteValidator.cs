...
namespace Application.Interfaces.Validators
{
    public interface IMatchInviteValidator
    {
        ...
        public void ValidateSendMatchInvite(Team receiver, Team sender, MatchInvite matchInviteFind, Matches findMatchWith12hours, string namePitch);
        ...
        public void ValidateNegociateMatchInvite(string namePitch, Pitch pitch, MatchInvite matchInvite, Team senderTeam, Team receiverTeam, Matches findMatchWith12hour);
