...
//criar/editar/remover equipas; gerir admins e membros.
{
    ...
    public class TeamService : ITeamService
    {
        ...
        private readonly ISuperAdminRepository UserRepository;
        private readonly IUnityOfWork UnityOfWork;
        private readonly IRankRepository RankRepository;
        private readonly ITeamValidator TeamValidator;

        public TeamService(ITeamRepository teamRepository, IPlayerRepository playerRepository, ISuperAdminRepository userRepository, IUnityOfWork unitOfWork, ITeamValidator teamValidator, IRankRepository rankRepository)
        {
